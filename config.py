...
BOT_TOKEN = getenv("BOT_TOKEN", "7298817176:AAHwPplwsUEBwWQfd43Klrys8_amWI5FTVU")
...
LOG_GROUP = getenv("LOG_GROUP", "4738304720")
CHANNEL_ID = int(getenv("CHANNEL_ID", "4738304720"))
